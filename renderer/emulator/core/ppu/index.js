...
class PPU {
  ...
  constructor(nes) {
    ...
    // FORGE PATCH: use the same 64 colours the editors draw with (see
    // palette-table.js) instead of upstream's hue-reversed NTSC table.
    this.palTable.loadForgePalette();
